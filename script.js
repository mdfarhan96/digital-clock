...
function settime() {
    ...
    if(a==hourr){
        document.getElementById("right-container-image").style.backgroundImage="(assests/morning.png)";
        document.getElementById("right-container-text").innerHTML="Breakfast Time!"
        div_var1 =1;
    }
    else if(b==hourr){
        document.getElementById("right-container-image").style.backgroundImage="url(assests/lunch.png)";
        document.getElementById("right-container-text").innerHTML="Lunch Time!"
        div_var2 =1;
    }
    else if(c==hourr){
        document.getElementById("right-container-image").style.backgroundImage="url(assests/gooodnight.png)";
